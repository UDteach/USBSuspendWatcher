...
func japaneseStrings() uiStrings {
	return uiStrings{
		...
		deviceColumnTitles:     []string{"監視・名前", "状態", "VID/PID", "電源", "列挙子", "COM", "場所", "接続時刻", "最終確認", "InstanceId", "ParentInstanceId", "ContainerId", "Class", "ClassGuid", "Service", "Driver", "VID", "PID", "LocationPath", "BusReportedDeviceDesc", "PDO Name"},
...
func englishStrings() uiStrings {
	return uiStrings{
		...
		deviceColumnTitles:     []string{"Monitor / Name", "State", "VID/PID", "Power", "Enumerator", "COM", "Location", "Connected", "Last seen", "InstanceId", "ParentInstanceId", "ContainerId", "Class", "ClassGuid", "Service", "Driver", "VID", "PID", "LocationPath", "BusReportedDeviceDesc", "PDO Name"},
		groupColumnTitles:      []string{"Group", "Score", "Port", "Converter", "Parent"},
